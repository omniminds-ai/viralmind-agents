    ...
    <div class="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-4">
      <div class="text-center">
        ...
        <p class="mx-auto mb-4 max-w-3xl text-xl text-gray-300 md:text-2xl">
          Trained directly on human behavior. No OCR - our agents natively learn the screen, keyboard, and mouse just like you do.
        </p>
...
<div class="relative overflow-hidden bg-gradient-to-b from-black to-purple-900">
  <!-- Decorative Elements -->
  <div class="absolute inset-0 bg-grid-black/[0.02]"></div>
    ...
    <div class="rounded-3xl bg-white/60 p-8 shadow-2xl backdrop-blur-sm">
      <div class="grid gap-8 md:grid-cols-2">
        ...
        <div class="flex flex-col justify-center">
          <h2 class="mb-4 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-4xl font-bold text-transparent">
            Your Ultimate<br/>AI Companion
          </h2>
          <p class="mb-6 text-xl text-gray-900">
            VM-1 agents that play your games, analyze your data, and handle your tasks - just like a human would.
          </p>
    ...
    <div class="mx-auto max-w-6xl px-4 py-24">
      <div class="text-center">
        ...
        <p class="mx-auto mb-16 max-w-2xl text-xl text-gray-300">
          Training powerful agents is now efficient and rewarding, powered by the $VIRAL token ecosystem
        </p>
        ...
        <div class="grid gap-8 md:grid-cols-3">
          <div class="rounded-xl bg-black/30 p-8">
            ...
            <p class="text-gray-400">
              Play games and complete tasks in our Training Gym. Your behavior becomes high-quality training data.
            </p>
          </div>
          ...
          <div class="rounded-xl bg-black/30 p-8">
            ...
            <p class="text-gray-400">
              Get rewarded in $VIRAL tokens for quality demonstrations. Build valuable datasets others can use.
            </p>
          </div>
...
<div class="bg-gradient-to-b from-purple-900/20 to-black">
  <div class="mx-auto max-w-6xl px-4 py-24">
    ...
    <p class="mb-16 text-center text-xl text-gray-400">Train your own LAM in minutes. Keep the weights.</p>
    
    <div class="grid gap-8 md:grid-cols-2">
      <div class="rounded-xl bg-black/30 p-8">
        <div class="mb-8">
          <span class="text-5xl font-bold text-purple-400">30%</span>
          <p class="mt-2 text-gray-400">Success rate on office UI tasks vs 0% with traditional OCR - tested on real computer-use benchmarks</p>
        </div>
        <div class="mb-8">
          <span class="text-5xl font-bold text-purple-400">50</span>
          <p class="mt-2 text-gray-400">Tasks to train a capable agent through our Training Gym</p>
        </div>
        <div class="mb-8">
...
<div class="mx-auto max-w-6xl px-4 py-24">
  <div class="text-center">
    <!-- Contract Info -->
    <div class="mb-8 rounded-xl bg-stone-900/30 backdrop-blur-md p-6">
      ...
      <div class="space-y-8">
        ...
        <div class="rounded-xl bg-black/30 p-8">
          ...
          <ul class="space-y-4 text-left text-gray-300">
            <li class="flex items-start gap-3">
              ...
              <span>Fair compensation for high-quality training data - users earn $VIRAL for contributing validated behavioral demonstrations</span>
            </li>
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
              <span>Cost-effective data collection through token incentives reduces training costs compared to traditional methods</span>
            </li>
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
              <span>Transparent data marketplace where contributors maintain ownership and earn from dataset usage</span>
            </li>
          </ul>
        </div>        
        ...
        <div class="rounded-xl bg-black/30 p-8">
          ...
          <ul class="space-y-4 text-left text-gray-300">
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
              <span>Building next-gen LAMs that understand any UI, game, or application, essential for business automation</span>
            </li>
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
            ...
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
              <span>Revolutionary AI companion tech - your agent plays games with you in real-time</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="space-y-8">
        <div class="rounded-xl bg-black/30 p-8">
          ...
          <ul class="space-y-4 text-left text-gray-300">
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
              <span>Behavioral cloning with automated validation ensures high-quality demonstrations</span>
            </li>
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
              <span>One-click deployment handled by our infrastructure - we manage the complexity so you don't have to</span>
            </li>
            <li class="flex items-start gap-3">
              <ArrowRight class="mt-1 h-5 w-5 flex-shrink-0 text-purple-400" />
    ...
    <div class="mt-12 rounded-xl bg-purple-500/10 p-8">
      ...
      <p class="mt-2 text-gray-300">
        Join us in building the next generation of AI agents - capable of using any computer interface just like humans do.
      </p>
      <div class="mt-8 flex justify-center gap-4">
        ...
        <ButtonCTA href="https://t.me/viralmind" variant="secondary">
          Join Community
        </ButtonCTA>
      </div>
    </div>
    ...
    <div class="rounded-3xl bg-black/30 p-12">
      ...
      <div class="mx-auto max-w-3xl text-center">
        <p class="mb-8 text-xl text-gray-300">
          We're a team of passionate AI researchers and engineers from MIT, Microsoft, and leading AI labs, united by a vision to democratize frontier AI research.
        </p>
        <p class="text-lg text-gray-400">
          Our mission is to bring powerful Large Action Models to the crypto community, creating a decentralized ecosystem where anyone can train and deploy truly capable AI agents.
        </p>
      </div>
...
<div class="mx-auto max-w-6xl px-4 py-24">
  ...
  <div class="mx-auto max-w-6xl px-4 py-24 text-center">
    ...
    <p class="mb-12 text-xl text-gray-400">Join our community of researchers, developers, and AI enthusiasts</p>
    <div class="flex justify-center gap-4">
      <ButtonCTA href="/gym">
        Start Training
        <ArrowRight class="h-5 w-5" />
      </ButtonCTA>
      <ButtonCTA href="https://viralmind.gitbook.io/viralmind.ai">
        Read Docs
      </ButtonCTA>
    </div>
  </div>
