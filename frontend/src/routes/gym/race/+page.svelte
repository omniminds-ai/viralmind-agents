<script lang="ts">
    ...
    function calculateMotion(points: DragPoint[]): DragPoint[] {
        ...
        for (let i = 1; i < points.length; i++) {
            ...
            if (i > 1 && prevPoint.velocity && prevPoint.velocity.x !== undefined && prevPoint.velocity.y !== undefined) {
    ...
    function handleMouseUp(e: MouseEvent & { currentTarget: HTMLImageElement }) {
        ...
        if (isDragging) {
            ...
            const dragAction = dragButton === 0 ? 'left_click_drag' : 
                             dragButton === 2 ? 'right_click_drag' : 
                             'middle_click_drag';
...
<div class="flex h-[calc(100vh-theme(spacing.16)-theme(spacing.20))] bg-black">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="flex-1 flex items-center justify-center p-6">
            <div 
                class="overflow-hidden rounded-xl shadow-lg bg-black/50"
