<script lang="ts">
  ...
  import { Sparkles, Hammer, Dumbbell, Brain, Bot, User, Search } from 'lucide-svelte';
  ...
  function handleGenerateGym() {
    if (dreamAgentInput) {
      window.location.href = `/new-gym?prompt=${encodeURIComponent(dreamAgentInput)}`;
    }
  }
</script>
...
<div class="min-h-screen">
      ...
      <div class="grid items-start gap-4 lg:grid-cols-2">
        ...
        <div>
          ...
          <p class="mb-6 text-xl text-gray-600">
            Join us in pioneering the future of AI through crowdsourced computer-use demonstrations. Together, we're pushing the boundaries of open-source frontier AI, making powerful computer-use agents accessible to everyone.
          </p>
          <a 
  ...
  <section class="bg-gray-50 py-20">
    <div class="mx-auto max-w-6xl px-4 text-center">
      ...
      <p class="mb-8 text-xl text-gray-600">
        Start earning from contributing skills
      </p>
      <ButtonCTA href="/download" class="inline-block">
        Download Windows
      </ButtonCTA>
    </div>
  </section>
    ...
    <div class="mx-auto max-w-6xl px-4">
      ...
      <div class="mb-20 grid items-center gap-12 lg:grid-cols-2">
        ...
        <div class="text-center lg:text-left">
          ...
          <ButtonCTA href="/demo/training-gym" variant="secondary" class="inline-flex items-center gap-2">
      ...
      <div class="mb-20 grid items-center gap-12 lg:grid-cols-2">
        <div class="order-2 lg:order-1 text-center lg:text-left">
          ...
          <ButtonCTA href="/demo/forge" variant="secondary" class="inline-flex items-center gap-2">
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <circle cx="12" cy="12" r="10"/>
              <polygon points="10 8 16 12 10 16" fill="currentColor"/>
            </svg>
      ...
      <!-- ML Research -->
      <div class="mb-20 grid items-center gap-12 lg:grid-cols-2">
        <div class="relative rounded-md bg-gray-100 overflow-hidden border shadow-2xl">
          <video 
            src={data} 
            autoplay 
            loop 
        ...
        <div class="text-center lg:text-left">
          <div class="mb-4 flex items-center gap-3">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Advanced ML Research</h2>
          </div>
          <p class="mb-6 text-lg text-gray-600">
            Process recordings into AI training data instantly. Cutting-edge research made accessible through simple GUI.
          </p>
          <ButtonCTA href="/research" variant="secondary" class="inline-flex items-center gap-2">
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <circle cx="12" cy="12" r="10"/>
              <polygon points="10 8 16 12 10 16" fill="currentColor"/>
            </svg>
      ...
      <div class="grid items-center gap-12 lg:grid-cols-2">
        <div class="text-center lg:text-left">
          ...
          <h2 class="mb-4 text-3xl font-bold text-gray-900">Computer Use Agent</h2>
          <p class="mb-6 text-lg text-gray-600">
            Chat with VM-1, a state-of-the-art computer-use agent trained with the data collected by the community. Experience the future of AI-powered computer interaction.
          </p>
          <ButtonCTA href="/demo/agent-chat" variant="secondary" class="inline-flex items-center gap-2">
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <circle cx="12" cy="12" r="10"/>
              <polygon points="10 8 16 12 10 16" fill="currentColor"/>
            </svg>
  ...
  <!-- Research & Custom Agents Section -->
  <section class="bg-gray-50 py-20">
    <div class="mx-auto max-w-6xl px-4">
      <div class="grid gap-12 lg:grid-cols-2">
        <!-- Researchers Section -->
        <div class="rounded-xl bg-white p-8 shadow-lg border border-gray-100">
          <h2 class="mb-4 text-3xl font-bold text-gray-900">For Researchers</h2>
          <p class="mb-6 text-lg text-gray-600">
            Access our comprehensive dataset of computer-use demonstrations. Perfect for research in human-AI interaction and computer-use automation.
          </p>
          <a 
            href="http://localhost/datasets" 
            class="inline-block rounded-lg bg-purple-600 px-6 py-3 text-white hover:bg-purple-700 transition-colors"
          >
            Explore Datasets
          </a>
        </div>
        ...
        <div class="rounded-xl bg-white p-8 shadow-lg border border-gray-100">
          <h2 class="mb-4 text-3xl font-bold text-gray-900">Need Specialized Agents?</h2>
          <p class="mb-6 text-lg text-gray-600">
            Define your AI training focus and we'll generate tasks to crowdsource the data needed for your specialized computer-use agent.
          </p>
          <a 
            href="/new-gym" 
            class="inline-block rounded-lg bg-blue-600 px-6 py-3 text-white hover:bg-blue-700 transition-colors"
          >
            Create Custom Agent
          </a>
        </div>
