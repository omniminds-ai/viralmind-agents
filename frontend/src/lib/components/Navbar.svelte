...
<div class="fixed left-0 right-0 top-0 z-50 text-gray-600 transition-all duration-300">
  ...
  <div class="relative z-10 mx-auto max-w-7xl px-6">
      ...
      <div class="flex items-center space-x-8">
        <a href="/" class="group flex items-center">
          ...
          <img
            src={logoTitle}
            alt="ViralMind"
            class="h-8 transition-transform group-hover:scale-105 lg:hidden"
          />
        </a>
        ...
        <nav class="hidden items-center space-x-8 lg:flex">
          ...
          <div class="relative">
            <button
              class="group flex items-center gap-2 text-sm font-medium text-gray-600 transition-colors hover:text-gray-900 navbar-dropdown-button"
    ...
    {#if isMobileMenuOpen}
      <div
        transition:slide
        class="absolute left-0 right-0 top-16 border-b border-gray-200 bg-white/95 backdrop-blur-lg md:hidden"
      >
